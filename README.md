...
这是一个充满未来感的赛博朋克风格个人技术主页，融合了霓虹灯效、动态粒子和炫酷光效，专注于展示后端开发、分布式系统和AI技术方面的专业能力。

### ✨ 特色

- 🌃 **赛博朋克美学**: 霓虹色彩 + 深空背景，营造未来科技感
- ⚡ **动态光效系统**: 
  - Matrix代码雨效果
  - 动态光束追踪
  - 粒子轨迹连线
  ...
  - 卡片光泽扫过
  - 呼吸灯效果
- 💫 **欢迎页面**: 打字机效果 + 赛博网格 + 滚动提示动画
- 💻 **霓虹灯效**: 多层发光阴影，青/粉/紫/绿四色霓虹
- 🎨 **故障艺术**: RGB分离的glitch效果
- 🔧 **终端风格**: 等宽字体 + 命令行提示符
- 📱 **响应式布局**: 完美适配各种屏幕尺寸
- ⚡ **高性能**: Canvas + CSS动画，流畅不卡顿
